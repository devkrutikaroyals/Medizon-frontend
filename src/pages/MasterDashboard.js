...
const MasterDashboard = () => {
  ...
  useEffect(() => {
    axios
      .get("https://medzionbackend.onrender.com/api/total-products")
      .then((response) => setTotalProducts(response.data.totalProducts || 0))
      .catch((error) => console.error("Error fetching products:", error));

    axios
      .get("https://medzionbackend.onrender.com/api/total-manufacturers")
  ...
  useEffect(() => {
    ...
    if (activeSection === "products") {
      axios.get("https://medzionbackend.onrender.com/api/products", {
    ...
    if (activeSection === "categories") {
      axios
        .get("https://medzionbackend.onrender.com/api/categories", {
          headers: {
    ...
    if (activeSection === "companies") {
      axios
        .get("https://medzionbackend.onrender.com/api/manufacturers", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
  ...
  const fetchPendingManufacturers = async () => {
    try {
      const token = localStorage.getItem("token");
      const response = await axios.get("https://medzionbackend.onrender.com/api/auth/pending-manufacturers", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const handleApprove = async (email) => {
    try {
      const token = localStorage.getItem("token");
      await axios.post(
        "https://medzionbackend.onrender.com/api/auth/authorize",
        { email },
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const handleDecline = async (email) => {
    try {
      const token = localStorage.getItem("token");
      await axios.post(
        "https://medzionbackend.onrender.com/api/auth/decline-manufacturer",
        { email },
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handlePasswordUpdate = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        "https://medzionbackend.onrender.com/api/auth/update-password",
  ...
  const handleCategoryClick = async (categoryName) => {
    ...
    try {
      const response = await axios.get(`https://medzionbackend.onrender.com/api/products/by-category/${categoryName}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
